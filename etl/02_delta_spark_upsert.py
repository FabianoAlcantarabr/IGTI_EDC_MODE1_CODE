...
enemnovo = (
    ...
    .load("s3://datalake-fabianoalcantara-igti-edc-tf/staging-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-fabianoalcantara-igti-edc-tf/staging-zone/enem")
